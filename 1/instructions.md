...
- All Team members should be collaborators on the Repo
...
>[!NOTE]
> Repo's README.md link (based on the [Project Proposal Template](project_proposal_template.md)) are sent to *qassas.ahmed@mau.edu.eg* **before 1 November**  

> [!IMPORTANT]
> Emails should be professionally written (**You may use AI tool**)